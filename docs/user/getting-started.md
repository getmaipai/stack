...
The first time you open the Stack, the board is ready immediately. It shows
what this computer can run in plain words, then lets you choose **Start
small** or a full plan in **Add abilities**. Downloads continue in the
background with their size, speed, time left, source, licence, and pause or
resume controls.
