...
export const showroomModels = [
  ...
  { id: "flux2-klein", roles: ["image"], state: "installed" as const, sizeBytes: 12_800_000_000, measuredFootprintBytes: 19_100_000_000, estimated: false, source: "huggingface", groupId: "group-media", nickname: "Pictures", provenance: { repo: "black-forest-labs/FLUX.2-klein", licence: "Apache-2.0", nickname: "Pictures" } },
...
export const showroomGroups = [
  { id: "group-family", name: "Family chat", parentId: null as string | null, modelCount: 2, bytesOnDisk: 22_300_000_000, memoryBytes: 28_400_000_000, usage: { requests: 1842, tokens: 142421 }, status: { loaded: 1, ready: 1, onDemand: 0, failed: 0 }, worstHealth: null },
  { id: "group-kids", name: "Kids", parentId: null, modelCount: 1, bytesOnDisk: 2_600_000_000, memoryBytes: 3_400_000_000, usage: { requests: 390, tokens: 22890 }, status: { loaded: 1, ready: 1, onDemand: 0, failed: 0 }, worstHealth: null },
  { id: "group-voice", name: "Voice", parentId: null, modelCount: 2, bytesOnDisk: 295_000_000, memoryBytes: 600_000_000, usage: { requests: 621, tokens: 0 }, status: { loaded: 0, ready: 2, onDemand: 0, failed: 0 }, worstHealth: null },
  { id: "group-media", name: "Media", parentId: null, modelCount: 1, bytesOnDisk: 12_800_000_000, memoryBytes: 0, usage: { requests: 16, tokens: 0 }, status: { loaded: 0, ready: 1, onDemand: 1, failed: 0 }, worstHealth: "warning" },
];
