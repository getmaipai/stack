...
export const showroomModels = [
  { id: "qwen3-27b-instruct", roles: ["chat", "coding", "judge"], state: "installed" as const, sizeBytes: 17_200_000_000, measuredFootprintBytes: 21_600_000_000, estimated: false, source: "catalog", provenance: { source: "getmaipai/catalog", licence: "Apache-2.0", nickname: "Family chat" } },
  { id: "qwen3-8b-instruct", roles: ["chat"], state: "installed" as const, sizeBytes: 5_100_000_000, measuredFootprintBytes: 6_800_000_000, estimated: false, source: "huggingface", provenance: { repo: "Qwen/Qwen3-8B", licence: "Apache-2.0", nickname: "Family chat" } },
  { id: "qwen3-4b-kids", roles: ["chat"], state: "installed" as const, sizeBytes: 2_600_000_000, measuredFootprintBytes: 3_400_000_000, estimated: false, source: "catalog", provenance: { source: "getmaipai/catalog", licence: "Apache-2.0", nickname: "Kids" } },
  { id: "moonshine-base", roles: ["stt"], state: "installed" as const, sizeBytes: 230_000_000, measuredFootprintBytes: 420_000_000, estimated: false, source: "catalog", provenance: { source: "getmaipai/catalog", licence: "MIT", nickname: "Voice" } },
  { id: "piper-en-us", roles: ["tts"], state: "installed" as const, sizeBytes: 65_000_000, measuredFootprintBytes: 180_000_000, estimated: false, source: "catalog", provenance: { source: "getmaipai/catalog", licence: "MIT", nickname: "Voice" } },
  { id: "flux2-klein", roles: ["image"], state: "installed" as const, sizeBytes: 12_800_000_000, measuredFootprintBytes: 19_100_000_000, estimated: false, source: "huggingface", provenance: { repo: "black-forest-labs/FLUX.2-klein", licence: "Apache-2.0", nickname: "Pictures" } },
  { id: "llama-3-8b-experiment", roles: ["chat"], state: "installed" as const, sizeBytes: 4_800_000_000, measuredFootprintBytes: null, estimated: true, source: "huggingface", provenance: { repo: "meta-llama/Llama-3-8B", licence: "Llama 3", nickname: "Experiments" } },
  { id: "mistral-small-experiment", roles: ["chat"], state: "installed" as const, sizeBytes: 8_100_000_000, measuredFootprintBytes: null, estimated: true, source: "huggingface", provenance: { repo: "mistralai/Mistral-Small", licence: "Apache-2.0", nickname: "Experiments" } },
];
