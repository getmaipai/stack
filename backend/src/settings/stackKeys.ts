...
export const STACK_SETTINGS: StackSettingDeclaration[] = [
  ...
  { key: "autoUpdateEngines", type: "boolean", default: false, label: "Update engines automatically", help: "Apply available engine updates during the maintenance window. Models never update automatically.", group: "Update checks", disclosure: "basic", needsRestart: false, section: "updates", order: 20 },
  { key: "huggingFaceSearchEnabled", type: "boolean", default: false, label: "Search Hugging Face", help: "Allow the Add sheet to send the search text and selected repository name to Hugging Face. This is separate from update checks.", group: "Model discovery", disclosure: "basic", needsRestart: false, section: "updates", order: 30 },
  ...
  { key: "alertWeeklyDigest", type: "boolean", default: false, label: "Tell me the weekly summary", help: "Show a weekly summary of what was used, what updated, what is tight, and what could be cleaned.", group: "Notifications", disclosure: "basic", needsRestart: false, section: "alerts", order: 60 },
  ...
  { key: "idleUnloadMinutes", type: "number", default: 30, label: "Unload chat after", help: "Unload an unused chat model after this many minutes on power.", group: "Ready when you sit down", disclosure: "basic", needsRestart: false, range: { min: 1, max: 1440 }, section: "maintenance", order: 40 },
  { key: "idleUnloadOnBatteryMinutes", type: "number", default: 10, label: "Unload chat on battery after", help: "Unload an unused chat model sooner when this computer is on battery power.", group: "Ready when you sit down", disclosure: "basic", needsRestart: false, range: { min: 1, max: 1440 }, section: "maintenance", order: 50 },
  { key: "chatWarmupEnabled", type: "boolean", default: true, label: "Warm up chat before my usual time", help: "Use this Stack's local chat usage to load chat ten minutes before the hour you usually use it.", group: "Ready when you sit down", disclosure: "basic", needsRestart: false, section: "maintenance", order: 60 },
