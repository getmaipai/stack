...
export const STACK_SETTINGS: EngineSettingDeclaration[] = [
  { key: "updatesEnabled", type: "boolean", default: false, label: "Check for updates", help: "Allow the Stack to check its release manifests when you ask it to.", group: "Updates", disclosure: "basic", needsRestart: false },
  { key: "lanAccess", type: "boolean", default: false, label: "LAN access", help: "Expose the Stack beyond this computer. A restart is required and operator sign-in remains required.", group: "Network and access", disclosure: "basic", needsRestart: true },
];
...
function valueSchema(declaration: EngineSettingDeclaration): z.ZodTypeAny { return declaration.type === "boolean" ? z.boolean() : z.string(); }
