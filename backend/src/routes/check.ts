...
const ResultSchema = z.object({ role: z.string(), ok: z.boolean(), ms: z.number().int(), reason: z.string().nullable(), skipped: z.boolean().optional() });
const CheckSchema = z.object({ at: z.string(), ok: z.boolean(), results: z.array(ResultSchema), fitTogether: z.object({ ok: z.boolean(), reason: z.string().nullable() }) });
