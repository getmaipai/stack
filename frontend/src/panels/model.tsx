...
export interface ModelPanelData { id: string; nickname?: string; group?: string; source?: string; licence?: string; licenceSentence?: string; licenceUrl?: string | null; modelPath?: string | null; sizeBytes?: number | null; measuredFootprintBytes?: number | null; runtimeState?: string; }
