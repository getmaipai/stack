...
export function DashboardShell() {
  ...
  const detected = useApiResource<{ detected: unknown[] }>("/stack/v1/detected");
  ...
  const engineCount = engines.data?.engines?.filter((engine) => engine.installed).length ?? 0;
