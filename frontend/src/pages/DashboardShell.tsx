...
const sections = ["Overview", "Engines", "Models", "Library", "Clients", "Tester", "Monitoring", "Settings", "Logs", "Alerts"];
const sectionPaths: Record<string, string> = { Overview: "/", Engines: "/engines", Models: "/models", Library: "/library", Clients: "/access", Tester: "/try", Monitoring: "/monitoring", Settings: "/settings", Logs: "/logs", Alerts: "/alerts" };
