...
const sectionPaths: Record<string, string> = { Overview: "/", Engines: "/engines", Models: "/models", Library: "/library", Help: "/help", Clients: "/access", Tester: "/try", Monitoring: "/monitoring", Settings: "/settings", Logs: "/logs", Alerts: "/alerts" };
