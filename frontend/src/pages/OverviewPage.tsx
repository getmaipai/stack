...
function FactsColumn({ className = "", desktop = false, hardware, healthz, budget, updates, counts, onSpeedTest, onCheckStack, speedTesting }: { className?: string; desktop?: boolean; hardware?: HardwareResponse["hardware"]; healthz?: { version: string; uptimeSeconds: number }; budget?: BudgetResponse; updates?: UpdatesResponse; counts: { engines: number; models: number; clients: number }; onSpeedTest: () => void; onCheckStack: () => void; speedTesting: boolean }) {
