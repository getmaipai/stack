...
import type { BudgetResponse, HardwareResponse, HealthItem, NotificationRecord, RoleRecord } from "@/lib/api";
...
type SeriesSample = { at: string; ability?: string | null; requests?: number; tokensIn?: number; tokensOut?: number; freeBytes?: number; pressure?: string; tokensPerSecond?: number | null };
...
function FactsColumn({ className = "", desktop = false, hardware, healthz, budget, updates, counts, onSpeedTest, onCheckStack }: { className?: string; desktop?: boolean; hardware?: HardwareResponse["hardware"]; healthz?: { version: string; uptimeSeconds: number }; budget?: BudgetResponse; updates?: UpdatesResponse; counts: { engines: number; models: number; clients: number }; onSpeedTest: () => void; onCheckStack: () => void }) {
